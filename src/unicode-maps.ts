 ...
 */
function toUnicodeChar(char: string, baseUpper: number, baseLower: number, baseNum?: number): string {
...
export const unicodeStyles = {
  bold: {
    uppercase: (char: string) => toUnicodeChar(char, 0x1D400, 0x1D41A, 0x1D7CE),
    lowercase: (char: string) => toUnicodeChar(char, 0x1D400, 0x1D41A, 0x1D7CE),
    numbers: (char: string) => toUnicodeChar(char, 0x1D400, 0x1D41A, 0x1D7CE),
  } as UnicodeStyle,
  
  italic: {
    uppercase: (char: string) => toUnicodeChar(char, 0x1D434, 0x1D44E),
  ...
  boldItalic: {
    uppercase: (char: string) => toUnicodeChar(char, 0x1D468, 0x1D482),
    lowercase: (char: string) => toUnicodeChar(char, 0x1D468, 0x1D482),
    numbers: undefined,
  } as UnicodeStyle,
  
  monospace: {
    uppercase: (char: string) => toUnicodeChar(char, 0x1D670, 0x1D68A, 0x1D7F6),
    lowercase: (char: string) => toUnicodeChar(char, 0x1D670, 0x1D68A, 0x1D7F6),
    numbers: (char: string) => toUnicodeChar(char, 0x1D670, 0x1D68A, 0x1D7F6),
  } as UnicodeStyle,
};
 ...
 */
export function convertToUnicodeStyle(text: string, style: keyof typeof unicodeStyles): string {
 ...
 */
export function unicodeToPlainText(text: string): string {
  return text.split('').map(char => {
